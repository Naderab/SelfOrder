...
export class ItemsService {
    ...
    async addModifierGroupToItem(idItem: string, idModiferGroup: string): Promise<Item> {
        return await this.ItemModel.findOneAndUpdate({ "_id": idItem }, { $push: { 'modifier_group_ids': idModiferGroup } });
